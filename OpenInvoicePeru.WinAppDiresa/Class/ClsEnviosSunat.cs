        ...
        public string CadenaDatos(string Tipo, string vEmpresa, string vFecha, string vGrupo)
        {
            ...
            switch (Tipo)
            {
                case "":
                    ...
                    vSql += " WHERE a.EmpresaID='" + vEmpresa + "' AND fechadocumento = '" + vFecha + "' AND DocumentoID = '" + vGrupo + "' AND b.ResumenSunat=0";
                ...
                case "RC":
                    ...
                    vSql += " AND isnull(b.GrupodeEnvioSunat,0)=" + vGrupo + " AND b.ResumenSunat=1 ";
