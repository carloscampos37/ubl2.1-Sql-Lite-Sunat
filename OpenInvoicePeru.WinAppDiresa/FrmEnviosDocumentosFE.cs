  ...
  if (vTipoDoc == "RA")
        ...
        private async void CrearXmlFact(int ii)
        {
            try
            {
                ...
                {
                    // nota de credito
                    var vRelacionado = new Jck.Comun.Dto.Modelos.DocumentoRelacionado();
                    ...
                    // nota de debito
                    var vDiscrepancia = new Jck.Comun.Dto.Modelos.Discrepancia();
        ...
        private async void CrearXmlBajas()
        {
            try
            {
                ...
                Jck.Comun.Dto.Modelos.ComunicacionBaja ComunicacionBaja = new Comun.Dto.Modelos.ComunicacionBaja();
                ...
                ComunicacionBaja.Bajas = new List<Jck.Comun.Dto.Modelos.DocumentoBaja>();

                for (int i3 = 0; i3 <= DtDocumentos.Rows.Count - 1; i3++)
                {
                    Jck.Comun.Dto.Modelos.DocumentoBaja DocumentoBajasItem = new Jck.Comun.Dto.Modelos.DocumentoBaja();
