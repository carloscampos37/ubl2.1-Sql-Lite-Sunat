Public Class FE_DocumentosElectronicosDetBE
...
Private mAfectacionIgv As String
Private mPorcentajeIgv As Decimal
Private mFechaRegistro As DateTime
...
Public Property PedidoNumero() As String
	...
	End Set
End Property
Public Property AfectacionIgv() As String
	Get
		Return(mAfectacionIgv)
	End Get
	Set (Value As String)
		mAfectacionIgv = Value
	End Set
End Property
