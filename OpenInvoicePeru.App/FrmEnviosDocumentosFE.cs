...
{
    public partial class FrmEnviosDocumentosFE : Form
    {
        ...
        private DataTable DetalleArticulos(DataTable dt, int iii)
        {
            ...
            try
            {
                ...
                SQL = " SELECT ProductodescripcionP=isnull(d.ProductoDescripcion,''''),ProductoServicios,PorcentajeIgv,UnidadMedida_Id,b.*, c.* FROM ";
