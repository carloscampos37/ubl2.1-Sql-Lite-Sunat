...
namespace OpenInvoicePeru.WinApp
{
...

    {
        ...
        private void FrmEnviarSunat_Load(object sender, EventArgs e)
        {
            ...
            DtEmpresa = ConsultarTabla(SQL, VGCnxSqlE);
            SQL1 = Convert.ToString(DtEmpresa.Rows[0]["CarpetaCertificadoDigital"])+"\\";
            SQL1 +=Convert.ToString(DtEmpresa.Rows[0]["NombrecertificadoDigital"]);

            txtNroRuc.Text = Convert.ToString(DtEmpresa.Rows[0]["Empresaruc"]);
            txtUsuarioSol.Text = Convert.ToString(DtEmpresa.Rows[0]["EmpresaUsuarioSol"]);
            txtClaveSol.Text = Convert.ToString(DtEmpresa.Rows[0]["EmpresaClaveSol"]);
            txtRutaCertificado.Text = SQL1;
            txtPassCertificado.Text = Convert.ToString(DtEmpresa.Rows[0]["PasswcertificadoDigital"]);
