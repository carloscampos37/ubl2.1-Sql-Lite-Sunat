...
using OpenInvoicePeru.Forms.Properties;
    ...
    public partial class FrmenviarSunat : Form
    {
        ...
        private async void BntXml_Click(object sender, EventArgs e)
        {
            try
            {
                if (string.IsNullOrEmpty(txtNroTicket.Text)) return;
        ...
        private void BntGeneraXml_Click(object sender, EventArgs e)
        {
            ...
            SQL = SQL + " WHERE a.Empresacodigo='" + LblCodigoEmpresa.Text + "' AND fechadocumento = '" + DtpFecha.Text + "'";
        ...
        private void BntEnvio_Click(object sender, EventArgs e)
        {
            try
            {
                txtResult.Text = "";
        ...
        private async void CrearResumen()
        {
            try
            {
                ...
                var firmadoRequest = new FirmadoRequest
                {
                    ...
                    CertificadoDigital = Convert.ToBase64String(File.ReadAllBytes(vRutaCertificado)),
                    PasswordCertificado = Convert.ToString(DtEmpresa.Rows[0]["PasswCertificadoDigital"]),
                    UnSoloNodoExtension = rbResumen.Checked || rbRetenciones.Checked
                };
        ...
        private void FrmEnvioDocumentosSunat_Load(object sender, EventArgs e)
        {
            String SQL = "";
            ...
            LblCodigoEmpresa.Text = Convert.ToString(DtEmpresa.Rows[0]["empresacodigo"]);
            LblEmpresa.Text = Convert.ToString(DtEmpresa.Rows[0]["empresadescripcion"]);
        }
