...
using OpenInvoicePeru.ServicioOse.Soap.Documentos;

namespace OpenInvoicePeru.ServicioOse.Soap
{
    public class ServicioOseDocumentos : IServicioSunatDocumentos
    {
        private Soap.Documentos.billServiceClient _proxyDocumentos;
